...
//  Classe: TCEnums
//
//  Data da Crição: 12/08/2019
//  Autor:
//  Descrição: Classe Contendo estrutura de Enums para Todos Retornos
//             da Dll de Integração Paygo - Versão Linux/Lazarus
//
//
//************************************************************************************************
unit uenums;
